<div class="modal-header">
    <h4 class="modal-title pull-left" id="myModalLabel">Registration Details</h4>
    <a id="form_submit" type="button" class="btn btn-default pull-right" href="<?php echo URL; ?>">Cancel Request</a>
    <br /><br />
</div>
