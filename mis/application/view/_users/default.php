<form action="<?php echo URL; ?>mis/login" method="post" autocomplete="on">
    <div class="form-group has-feedback">
        <input id="required" type="text" name="user_name" class="form-control username required" placeholder="Username or Email" required />
    </div>
    ...
    <div class="form-group has-feedback">
        <input id="required" type="password" name="user_password" class="form-control password required" placeholder="Password" required />
    </div>
