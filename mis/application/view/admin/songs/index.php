<div class="container">
    <h2>This content is ONLY a SAMPLE for reference and this will not be included in final product</h2>
    <!-- add song form -->
    <div class="box">
        <h3>Add a song</h3>
        ...
        <table>
            ...
            <?php foreach ($songs as $song) { ?>
                <tr>
                    ...
                    <td><a href="<?php echo URL . 'songs/deletesong/' . htmlspecialchars($song->id, ENT_QUOTES, 'UTF-8'); ?>" onclick="confirmation()">delete</a></td>
