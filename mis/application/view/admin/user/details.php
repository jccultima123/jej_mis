<div class="modal-header">
    <div class="btn-group pull-right">
        <a type="button" class="btn btn-default" href="<?php echo URL . 'admin/deleteUser/' . htmlspecialchars($user->user_id, ENT_QUOTES, 'UTF-8'); ?>">Delete User</a>
                ...
                <div class="col-md-9 col-md-offset-3">
                    ...
                    <div class="btn-group" data-toggle="buttons">
                        ...
                        <label class="btn btn-primary active">
                            <input type="radio" name="0" id="option2" autocomplete="off"> NOT NOW
                        </label>
                    </div>
                </div>
            </div>
