                        ...
                        <div class="panel-group" id="accordion">
                            ...
                            <div class="panel panel-default">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">
                                        <a id="load" class="btn btn-primary btn-block" href="<?php echo URL; ?>som/orders?a=add">Add</a>
                                        <a id="load" class="btn btn-primary <?php if ($orders==NULL) { echo 'disabled'; } ?> btn-block" href="<?php echo URL; ?>som/export/orders">Create Report</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
