    ...
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <select class="selectpicker pull-right" data-style="btn-primary" onchange="location = this.options[this.selectedIndex].value;" data-container="body">
                ...
                <option value="<?php echo URL . 'CRM/post/reply/' . htmlspecialchars($id, ENT_QUOTES, 'UTF-8'); ?>">Reply/Respond</option>
                <option value="<?php echo URL . 'CRM/post/delete/' . htmlspecialchars($id, ENT_QUOTES, 'UTF-8'); ?>">Delete</option>
            </select>
        </div>
    </div>
</div>
