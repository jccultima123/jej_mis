        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="btn-group pull-right">
                    <a type="button" class="btn btn-warning" href="<?php echo URL . 'forgotpassword/reset'?>">I have my code</a>
                ...
                <div class="alert alert-info" role="alert">
                    Have you forgotten the password? We can recover your password in two ways, to the mail (Sending you a password reset mail) and to the administrator, so be advised.
                </div>
            </div>
            <div class="modal-body">
                <?php $this->renderFeedbackMessages(); ?>
                <form action="<?php echo URL; ?>forgotpassword/passAction" method="POST" style="padding: 10px;" class="form-horizontal">
                    <fieldset>
